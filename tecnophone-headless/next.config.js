...
const nextConfig = {
  ...
  experimental: {
    optimizePackageImports: ['lucide-react', 'algoliasearch'],
  },
  async headers() {
    return [
      {
        ...
        headers: [
          ...
          { key: 'Strict-Transport-Security', value: 'max-age=63072000; includeSubDomains; preload' },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://wp.tecnophone.co https://www.tecnophone.co https://tecnophone.co https://http2.mlstatic.com https://*.mercadolibre.com https://crests.football-data.org",
              "font-src 'self' https://fonts.gstatic.com https://http2.mlstatic.com",
              "connect-src 'self' https://wp.tecnophone.co https://www.tecnophone.co https://tecnophone.co https://api.mercadopago.com https://events.mercadopago.com https://api.groq.com https://*.algolia.net https://*.algolianet.com https://api.web3forms.com",
